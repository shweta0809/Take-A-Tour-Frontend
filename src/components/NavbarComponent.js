      ...
      <div>
        ...
        <nav className="navbar navbar-expand-sm mb-3 c-navcolor">
          <div className="container-fluid ">
            <div className="c-webname">Take A Tour</div>

            <ul className="navbar-nav navbar-right ">
              <li className="nav-item ">
                <Link to="/" className="c-navlink px-3">
                  Home
                </Link>
              </li>
              ...
              >
                <Link to="/signup" className="c-navlink px-3">
                  Sign Up
                </Link>
              </li>
              ...
              <li
                ...
                style={{ display: b ? "none" : "block" }}
              >
                <Link to="/login" className="c-navlink px-3">
                  Login
                </Link>
              </li>
              <li
              ...
              >
                <Link to="/profile" className="c-navlink px-3">
                  welcome {tourist && tourist.t_fname}
                </Link>
              </li>
              <li
                className="nav-item "
                style={{ display: b ? "block" : "none" }}
              >
                <Link to="/aboutus" className="c-navlink px-3">
                  About Us
                </Link>
              </li>
              <li
                ...
                style={{ display: b ? "block" : "none" }}
              >
                <Link to="/logout" className="c-navlink px-3">
                  Logout
                </Link>
              </li>
            </ul>
